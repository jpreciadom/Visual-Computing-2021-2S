...
```html
{{</* p5-div sketch="/Visual-Computing-2021-2S/sketches/scintillating.js" */>}}
```
{{< /details >}}
...
{{</* p5-instance-div id="video" >}}
  ...
  p5.setup = function() {
    ...
    fingers = p5.createVideo(['/Visual-Computing-2021-2S/sketches/fingers.mov', '/Visual-Computing-2021-2S/sketches/fingers.webm']);
